...
public class Tower extends Module {
    ...
    private final ListValue modeValue = new ListValue("Mode", new String[] {
            "Jump", "Motion", "ConstantMotion", "MotionTP", "Packet", "Teleport", "AAC3.3.9", "AAC3.6.4", "AAC4"
    }, "Motion");
    ...
    private final IntegerValue aacv4JumpDelayValue = new IntegerValue("AAC4JumpDelay", 0, 0, 7);
