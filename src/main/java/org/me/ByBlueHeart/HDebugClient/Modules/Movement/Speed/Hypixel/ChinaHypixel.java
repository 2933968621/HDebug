...
public class ChinaHypixel extends SpeedMode {
    ...
    public void onMove(MoveEvent event) {
        ...
        if (!isInLiquid() && isOnGround(0.01) && (isMoving2())) {
            ...
            if (stage >= 0 || collided) {
                ...
                double a = (HDebug.moduleManager.getModule(BlockFly.class).getState() || HDebug.moduleManager.getModule(Scaffold.class).getState() || HDebug.moduleManager.getModule(HypixelBlockFly.class).getState() ? 0.407 : 0.41999742);
