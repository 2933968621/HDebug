...
@ModuleInfo(name = "AutoSay", description = "Auto Say Abuse Political SZJ And Null.", category = ModuleCategory.MISC, keyBind = Keyboard.KEY_L)
    ...
    public void onUpdate(UpdateEvent event) {
        if(msTimer.hasTimePassed(delay)) {
            ...
            switch (TextValue.get().toLowerCase()) {
                case "abuse":
                    mc.thePlayer.sendChatMessage(customValue.get() ? replace((HYTValue.get() ? "@" : "") + (PrefixValue.get() ? "[HDebug] " : "") + Abuse + (PrefixValue.get() ? " QQ群:1046127406 " : " ")) : (HYTValue.get() ? "@" : "") + (PrefixValue.get() ? "[HDebug] " : "") + Abuse + (ADValue.get() ? " QQ群:1128533970 " : " ") + " [" + RandomUtils.randomString(5 + new Random().nextInt(5)) + "]");
                    break;
                case "political":
                    mc.thePlayer.sendChatMessage(customValue.get() ? replace((HYTValue.get() ? "@" : "") + (PrefixValue.get() ? "[HDebug] " : "") + Political + (PrefixValue.get() ? " QQ群:1046127406 " : " ")) : (HYTValue.get() ? "@" : "") + (PrefixValue.get() ? "[HDebug] " : "") + Abuse + (ADValue.get() ? " QQ群:1128533970 " : " ") + " [" + RandomUtils.randomString(5 + new Random().nextInt(5)) + "]");
                    break;
                case "szj":
                    mc.thePlayer.sendChatMessage(customValue.get() ? replace((HYTValue.get() ? "@" : "") + (PrefixValue.get() ? "[HDebug] " : "") + SZJ + (PrefixValue.get() ? " QQ群:1046127406 " : " ")) : (HYTValue.get() ? "@" : "") + (PrefixValue.get() ? "[HDebug] " : "") + Abuse + (ADValue.get() ? " QQ群:1128533970 " : " ") + " [" + RandomUtils.randomString(5 + new Random().nextInt(5)) + "]");
                    break;
                case "null":
                    mc.thePlayer.sendChatMessage(customValue.get() ? replace((HYTValue.get() ? "@" : "") + (PrefixValue.get() ? "[HDebug] " : "") + Null + (PrefixValue.get() ? " QQ群:1046127406 " : " ")) : (HYTValue.get() ? "@" : "") + (PrefixValue.get() ? "[HDebug] " : "") + Abuse + (ADValue.get() ? " QQ群:1128533970 " : " ") + " [" + RandomUtils.randomString(5 + new Random().nextInt(5)) + "]");
                    break;
            }
            msTimer.reset();
            delay = TimeUtils.randomDelay(minDelayValue.get(), maxDelayValue.get());
