...
import net.blueheart.hdebug.features.module.modules.combat.AutoArmor
import net.blueheart.hdebug.injection.implementations.IItemStack
...
import net.blueheart.hdebug.utils.item.ArmorPiece
...
class InvManager : Module() {
    ...
    private val sortSlot6Value = ListValue("SortSlot-6", items, "Block")
