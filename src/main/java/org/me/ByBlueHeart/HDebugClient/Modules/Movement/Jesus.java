...
public class Jesus extends Module {
    ...
    public final ListValue modeValue = new ListValue("Mode", new String[] {"Vanilla", "NCP", "AAC", "AAC3.3.11", "AACFly", "Spartan", "Dolphin","Hypixel"}, "NCP");
    ...
    public void onUpdate(final UpdateEvent event) {
        ...
        if(modeValue.get().contains("Hypixel")){
