    ...
    public void onUpdate() {
        if (mc.thePlayer.moveForward > 0.0F)
            if (mc.thePlayer.onGround) {
                ...
                mc.timer.timerSpeed = ((Float)((Speed)HDebug.moduleManager.getModule(Speed.class)).custommatrixHopTimerValue.get()).floatValue();
                mc.thePlayer.motionX *= 1.0800000429153442D;
                mc.thePlayer.motionZ *= 1.0800000429153442D;
            } else if (mc.thePlayer.lastTickPosX > 0.0F) {
                mc.timer.timerSpeed = ((Float)((Speed)HDebug.moduleManager.getModule(Speed.class)).custommatrixHopTimerValue2.get()).floatValue();
            }
    }
