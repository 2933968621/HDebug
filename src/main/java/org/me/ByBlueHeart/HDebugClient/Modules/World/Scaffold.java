...
@ModuleInfo(name = "Scaffold", description = "Automatically places blocks beneath your feet.", category = ModuleCategory.WORLD, keyBind = Keyboard.KEY_X)
public class Scaffold extends Module {
    ...
    public void onRender2D(final Render2DEvent event) {
        if (counterDisplayValue.get()) {
            ...
            final String info = getBlocksAmount() + "¡ì7 Blocks";
