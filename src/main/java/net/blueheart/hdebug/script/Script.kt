 ...
 */
package net.blueheart.hdebug.script

import jdk.internal.dynalink.beans.StaticClass
import net.blueheart.hdebug.HDebug
import net.blueheart.hdebug.script.api.*
...
class Script(val scriptFile: File) : MinecraftInstance() {
    ...
    fun loadScript() {
        ...
        scriptEngine.put("scriptManager", HDebug.scriptManager)
    ...
    fun import(scriptFile : String) {
        scriptEngine.eval(File(HDebug.scriptManager.scriptsFolder, scriptFile).readText())
    }
