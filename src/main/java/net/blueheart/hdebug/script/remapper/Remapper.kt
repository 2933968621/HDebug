 ...
 */
package net.blueheart.hdebug.script.remapper
...
object Remapper {
    ...
    private val srgFile = File(HDebug.fileManager.dir, "mcp-$srgName.srg")
    ...
    fun loadSrg() {
        ...
        if(!srgFile.exists()) {
            ...
            HttpUtils.download("${HDebug.CLIENT_CLOUD}/srgs/mcp-$srgName.srg", srgFile)
