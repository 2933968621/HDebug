...
import net.blueheart.hdebug.event.TickEvent;
import net.blueheart.hdebug.features.module.modules.combat.FastBow;
...
public final class RotationUtils extends MinecraftInstance implements Listenable {
    ...
    public static void faceBow(final Entity target, final boolean silent, final boolean predict, final float predictSize) {
        ...
        float velocity = HDebug.moduleManager.getModule(FastBow.class).getState() ? 1F : player.getItemInUseDuration() / 20F;
