...
import net.blueheart.hdebug.features.module.modules.misc.NameProtect
import net.blueheart.hdebug.features.module.modules.misc.Spammer
import net.blueheart.hdebug.utils.misc.HttpUtils.get
import net.blueheart.hdebug.utils.misc.StringUtils
import net.blueheart.hdebug.utils.render.ColorUtils.translateAlternateColorCodes
...
object SettingsUtils {
            ...
            when (args[0]) {
                ...
                "load" -> {
                    ...
                    val url = if (urlRaw.startsWith("http"))
                        ...
                        "${HDebug.CLIENT_CLOUD}/settings/${urlRaw.toLowerCase()}"
                ...
                "targetDead" -> {
                    ...
                    val value = args[2]
                    val module = HDebug.moduleManager.getModule(moduleName)
    ...
    fun generateScript(values: Boolean, binds: Boolean, states: Boolean): String {
        ...
        HDebug.moduleManager.modules.filter {
