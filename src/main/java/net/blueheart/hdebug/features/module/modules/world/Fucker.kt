...
import net.blueheart.hdebug.features.module.modules.player.AutoTool
import net.blueheart.hdebug.utils.RotationUtils
import net.blueheart.hdebug.utils.block.BlockUtils.getBlock
import net.blueheart.hdebug.utils.block.BlockUtils.getBlockName
import net.blueheart.hdebug.utils.block.BlockUtils.getCenterDistance
import net.blueheart.hdebug.utils.block.BlockUtils.isFullBlock
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        when {
            ...
            actionValue.get().equals("destroy", true) || surroundings -> {
                // Auto Tool
                val autoTool = HDebug.moduleManager[AutoTool::class.java] as AutoTool
                if (autoTool.state)
