...
class BugUp : Module() {
    private val modeValue = ListValue("Mode", arrayOf("TeleportBack", "FlyFlag", "OnGroundSpoof", "MotionTeleport-Flag"), "TeleportBack")
    private val maxFallDistance = IntegerValue("MaxFallDistance", 20, 2, 255)
    private val maxDistanceWithoutGround = FloatValue("MaxDistanceToSetback", 20f, 1f, 30f)
    ...
    fun onRender3D(event: Render3DEvent) {
        ...
        RenderUtils.glColor(Color(56, 255, 255, 90))
