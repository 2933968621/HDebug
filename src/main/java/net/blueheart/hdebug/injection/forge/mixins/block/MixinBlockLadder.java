...
import net.blueheart.hdebug.features.module.modules.movement.FastClimb;
...
public abstract class MixinBlockLadder extends MixinBlock {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos) {
        ...
        if(iblockstate.getBlock() instanceof BlockLadder) {
            final FastClimb fastClimb = (FastClimb) HDebug.moduleManager.getModule(FastClimb.class);
