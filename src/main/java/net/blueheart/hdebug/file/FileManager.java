package net.blueheart.hdebug.file;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import net.blueheart.hdebug.HDebug;
import net.blueheart.hdebug.file.configs.*;
...
public class FileManager extends MinecraftInstance {
    public static File musicdir = new File("C:/HDebugMusicKit/", "BodaciousMusic");
    public static File musicdir2 = new File("C:/HDebugMusicKit/", "FrameOfMindMusic");
    public static File musicdir3 = new File("C:/HDebugMusicKit/", "EyeDragonMusic");
    public static File musicdir4 = new File("C:/HDebugMusicKit/", "BlackHumanMusic");

    public final File dir = new File(mc.mcDataDir, "HDebug-Config");
    ...
    private void saveConfig(final FileConfig config, final boolean ignoreStarting) {
        if (!ignoreStarting && HDebug.INSTANCE.isStarting())
            return;
    ...
    public void loadBackground() {
        if(backgroundFile.exists()) {
            try {
                ...
                HDebug.INSTANCE.setBackground(new ResourceLocation(HDebug.CLIENT_NAME.toLowerCase() + "/background.png"));
                mc.getTextureManager().loadTexture(HDebug.INSTANCE.getBackground(), new DynamicTexture(bufferedImage));
