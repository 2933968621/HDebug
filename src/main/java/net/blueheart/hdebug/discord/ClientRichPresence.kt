...
package net.blueheart.hdebug.discord
...
class ClientRichPresence : MinecraftInstance() {
    ...
    fun update() {
        ...
        if (assets.containsKey("logo"))
            builder.setLargeImage(assets["logo"], "MC ${HDebug.MINECRAFT_VERSION} - HDebug b"+HDebug.CLIENT_VERSION)
        ...
        if (mc.thePlayer != null) {
            ...
            builder.setState("Enabled ${HDebug.moduleManager.modules.count { it.state }} of ${HDebug.moduleManager.modules.size} modules")
        }
    ...
    private fun loadConfiguration() {
        ...
        val json = JsonParser().parse(HttpUtils.get("${HDebug.CLIENT_CLOUD}/discord.json"))
