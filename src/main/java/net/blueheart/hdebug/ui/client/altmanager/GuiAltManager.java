...
package net.blueheart.hdebug.ui.client.altmanager;

import com.google.gson.JsonElement;
import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import net.blueheart.hdebug.HDebug;
import net.blueheart.hdebug.ui.client.altmanager.sub.*;
...
public class GuiAltManager extends GuiScreen {
    ...
    public static void loadGenerators() {
        try {
            ...
            final JsonElement jsonElement = new JsonParser().parse(HttpUtils.get(HDebug.CLIENT_CLOUD + "/generators.json"));
    ...
    public static String login(final MinecraftAccount minecraftAccount) {
        ...
        if (result == LoginUtils.LoginResult.LOGGED) {
            ...
            HDebug.fileManager.saveConfig(HDebug.fileManager.accountsConfig);
    ...
    public void initGui() {
        ...
        for (int i = 0; i < HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.size(); i++) {
            MinecraftAccount minecraftAccount = HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.get(i);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.font35.drawCenteredString(HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.size() + " Alts", width / 2, 18, 0xffffff);
        ...
        switch (button.id) {
            ...
            case 2:
                if (altsList.getSelectedSlot() != -1 && altsList.getSelectedSlot() < altsList.getSize()) {
                    HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.remove(altsList.getSelectedSlot());
                    HDebug.fileManager.saveConfig(HDebug.fileManager.accountsConfig);
            ...
            case 3:
                if (altsList.getSelectedSlot() != -1 && altsList.getSelectedSlot() < altsList.getSize()) {
                    ...
                    final Thread thread = new Thread(() -> {
                        final MinecraftAccount minecraftAccount = HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.get(altsList.getSelectedSlot());
                        status = "§aLogging in...";
                ...
                break;
            case 4:
                if (HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.size() <= 0) {
                    status = "§cThe list is empty.";
                    return;
                }

                final int randomInteger = new Random().nextInt(HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.size());
                ...
                final Thread thread = new Thread(() -> {
                    final MinecraftAccount minecraftAccount = HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.get(randomInteger);
                    status = "§aLogging in...";
                    status = login(minecraftAccount);
            ...
            case 7:
                ...
                while ((line = bufferedReader.readLine()) != null) {
                    ...
                    for (final MinecraftAccount registeredMinecraftAccount : HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts) {
                    ...
                    if (!alreadyAdded) {
                        if (accountData.length > 1)
                            HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.add(new MinecraftAccount(accountData[0], accountData[1]));
                        else
                            HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.add(new MinecraftAccount(accountData[0]));
                    }
                }
            ...
            case 11:
                ...
                break;
            case 12:
                if (HDebug.fileManager.accountsConfig.getAccounts().size() == 0) {
                    status = "§cThe list is empty.";
                    return;
                }
                ...
                try {
                    ...
                    for (MinecraftAccount account : HDebug.fileManager.accountsConfig.getAccounts()) {
    ...
    private class GuiList extends GuiSlot {
        ...
        int getSelectedSlot() {
            if (selectedSlot > HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.size())
                selectedSlot = -1;
            return selectedSlot;
        }
        ...
        protected int getSize() {
            return HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.size();
        }
        ...
        protected void elementClicked(int var1, boolean doubleClick, int var3, int var4) {
            ...
            if (doubleClick) {
                if (altsList.getSelectedSlot() != -1 && altsList.getSelectedSlot() < altsList.getSize() && loginButton.enabled) {
                    ...
                    new Thread(() -> {
                        MinecraftAccount minecraftAccount = HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.get(altsList.getSelectedSlot());
                        status = "§aLogging in...";
        ...
        protected void drawSlot(int id, int x, int y, int var4, int var5, int var6) {
            final MinecraftAccount minecraftAccount = HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.get(id);
