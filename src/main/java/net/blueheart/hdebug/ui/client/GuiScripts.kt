...
class GuiScripts(private val prevGui: GuiScreen) : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        drawCenteredString(Fonts.font40, "§b§lScripts", width / 2, 28, 0xffffff)
        ...
        when (button.id) {
            ...
            2 -> try {
                if (list.getSelectedSlot() != -1) {
                    val script = HDebug.scriptManager.scripts[list.getSelectedSlot()]
    ...
    private inner class GuiList(gui: GuiScreen) :
        ...
        internal fun getSelectedSlot() = if (selectedSlot > HDebug.scriptManager.scripts.size) -1 else selectedSlot

        override fun getSize() = HDebug.scriptManager.scripts.size
        ...
        override fun drawSlot(id: Int, x: Int, y: Int, var4: Int, var5: Int, var6: Int) {
            val script = HDebug.scriptManager.scripts[id]
            drawCenteredString(Fonts.font40, "§b" + script.scriptName + " §7v" + script.scriptVersion, width / 2, y + 2, Color.LIGHT_GRAY.rgb)
