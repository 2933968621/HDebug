...
import net.blueheart.hdebug.utils.render.SafeVertexBuffer
import net.blueheart.hdebug.utils.render.shader.shaders.RainbowShader
            ...
            if (entity != null && entity !== mc.thePlayer && EntityUtils.isSelected(entity, false)) {
                ...
                if (triangleMode) {
                    if (useESPColorsValue.get()) {
                        val color = (HDebug.moduleManager[ESP::class.java] as ESP).getColor(entity)
