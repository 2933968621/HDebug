...
package net.blueheart.hdebug.ui.client.altmanager.sub;
...
import net.blueheart.hdebug.ui.elements.GuiPasswordField;
import net.blueheart.hdebug.ui.font.Fonts;
import net.blueheart.hdebug.utils.ClientUtils;
import net.blueheart.hdebug.utils.TabUtils;
...
public class GuiAdd extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        switch(button.id) {
            case 0:
                ...
                break;
            case 1:
                if (HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.stream().anyMatch(account -> account.getName().equals(username.getText()))) {
    ...
    private void addAccount(final String name, final String password) {
        if (HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.stream()
        ...
        new Thread(() -> {
            ...
            HDebug.fileManager.accountsConfig.altManagerMinecraftAccounts.add(account);
