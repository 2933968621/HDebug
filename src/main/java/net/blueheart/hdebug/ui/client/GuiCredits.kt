...
class GuiCredits(private val prevGui: GuiScreen) : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        if (list.getSelectedSlot() != -1) {
            ...
            if (credit.twitterName != null) {
                ...
                Fonts.font40.drawString("QQ: " + credit.twitterName, (width / 4 + 5).toFloat(), y.toFloat(), Color.WHITE.rgb, true)
            }

            if (credit.youtubeName != null) {
                y += Fonts.font40.FONT_HEIGHT
                Fonts.font40.drawString("BiliBili: " + credit.youtubeName, (width / 4 + 5).toFloat(), y.toFloat(), Color.WHITE.rgb, true)
            }
    ...
    private fun loadCredits() {
        ...
        try {
            val json = JsonParser()
                    .parse(HttpUtils.get("https://cpnh8n.coding-pages.com/Credits.json"))
            ...
            for (value in json) {
                ...
                credits.add(Credit(
                        ...
                        getInfoFromJson(value, "QQName"),
                        getInfoFromJson(value, "BiliBiliName"),
                        userCredits
                ))
            }
        } catch (e: Exception) {
