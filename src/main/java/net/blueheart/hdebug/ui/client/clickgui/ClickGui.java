package net.blueheart.hdebug.ui.client.clickgui;
...
import net.blueheart.hdebug.ui.client.clickgui.elements.Element;
...
public class ClickGui extends GuiScreen {
    ...
    private final ResourceLocation hudIcon = new ResourceLocation(HDebug.CLIENT_NAME.toLowerCase() + "/custom_hud_icon.png");
        ...
        for(final ModuleCategory category : ModuleCategory.values()) {
            panels.add(new Panel(category.getDisplayName(), 100, yPos, width, height, false) {
                ...
                public void setupItems() {
                    for (Module module : HDebug.moduleManager.getModules())
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        final double scale = ((ClickGUI) Objects.requireNonNull(HDebug.moduleManager.getModule(ClickGUI.class))).scaleValue.get();
        ...
        RenderUtils.drawFilledCircle(25, height - 25, 16, ColorUtils.rainbow(400000000L));
        RenderUtils.drawImage(hudIcon, 12, height - 35, 23, 23);
        Fonts.font35.drawStringWithShadow("HDebug Client By BlueHeart Dev",50,height - 10,ColorUtils.rainbow(400000000L).getRGB());
    ...
    public void onGuiClosed() {
        HDebug.fileManager.saveConfig(HDebug.fileManager.clickGuiConfig);
    }
