...
var _AdaptedModule = function (module) {
    ...
    this.moduleManager = Java.type("net.blueheart.hdebug.HDebug").moduleManager;
...
var _ModuleManager = function () {
    ...
    this.moduleManager = Java.type("net.blueheart.hdebug.HDebug").moduleManager;
    this.Module = Java.type("net.blueheart.hdebug.features.module.Module");
...
var _CommandManager = function () {
    ...
    this.Command = Java.type("net.blueheart.hdebug.features.command.Command");
    this.commandManager = Java.type("net.blueheart.hdebug.HDebug").commandManager;
